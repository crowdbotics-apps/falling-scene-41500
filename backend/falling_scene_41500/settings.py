"""
Django settings for falling_scene_41500 project.
...
ROOT_URLCONF = 'falling_scene_41500.urls'
...
WSGI_APPLICATION = 'falling_scene_41500.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_scene_41500 API",
    "DESCRIPTION": "API documentation for falling_scene_41500 App",
    "VERSION": "v1",
}
